...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Headphones.head_image'
        db.add_column(u'app_backend_headphones', 'head_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='headphones_head_image', null=True, on_delete=models.SET_NULL, to=orm['wagtailimages.Image']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Headphones.head_image'
        db.delete_column(u'app_backend_headphones', 'head_image_id')
