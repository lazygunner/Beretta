...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HeadphonesCarouselItem'
        db.create_table(u'app_backend_headphonescarouselitem', (
            ...
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='carousel_items', to=orm['app_backend.Headphones'])),
        ))
        db.send_create_signal(u'app_backend', ['HeadphonesCarouselItem'])

        # Adding model 'Headphones'
        db.create_table(u'app_backend_headphones', (
            ...
            ('transducer', self.gf('django.db.models.fields.CharField')(default='MC', max_length=2)),
            ('wear_type', self.gf('django.db.models.fields.CharField')(default='CI', max_length=2)),
            ('wire_length', self.gf('django.db.models.fields.FloatField')()),
            ('size', self.gf('django.db.models.fields.CharField')(max_length=127)),
            ('weight', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal(u'app_backend', ['Headphones'])

        # Adding model 'HeadphonesRelatedLink'
        db.create_table(u'app_backend_headphonesrelatedlink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('link_external', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
            ('link_page', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wagtailcore.Page'])),
            ...
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='related_links', to=orm['app_backend.Headphones'])),
        ))
        db.send_create_signal(u'app_backend', ['HeadphonesRelatedLink'])

        # Adding model 'BlogPageRelatedLink'
        db.create_table(u'app_backend_blogpagerelatedlink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('link_external', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
            ('link_page', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wagtailcore.Page'])),
            ('link_document', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wagtaildocs.Document'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='related_links', to=orm['app_backend.BlogPage'])),
        ))
        db.send_create_signal(u'app_backend', ['BlogPageRelatedLink'])


    def backwards(self, orm):
        # Deleting model 'HeadphonesCarouselItem'
        db.delete_table(u'app_backend_headphonescarouselitem')

        # Deleting model 'Headphones'
        db.delete_table(u'app_backend_headphones')

        # Deleting model 'HeadphonesRelatedLink'
        db.delete_table(u'app_backend_headphonesrelatedlink')

        # Deleting model 'BlogPageRelatedLink'
        db.delete_table(u'app_backend_blogpagerelatedlink')
