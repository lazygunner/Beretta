...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'app_backend_comment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('body', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='owned_comment', to=orm['auth.User'])),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('blog', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='comment', null=True, on_delete=models.SET_NULL, to=orm['app_backend.BlogPage'])),
        ))
        db.send_create_signal(u'app_backend', ['Comment'])


    def backwards(self, orm):
        # Deleting model 'Comment'
        db.delete_table(u'app_backend_comment')
