...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HeadphonesIndexPage.intro'
        db.delete_column(u'app_backend_headphonesindexpage', 'intro')

        # Deleting field 'BlogIndexPage.intro'
        db.delete_column(u'app_backend_blogindexpage', 'intro')


    def backwards(self, orm):
        # Adding field 'HeadphonesIndexPage.intro'
        db.add_column(u'app_backend_headphonesindexpage', 'intro',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'BlogIndexPage.intro'
        db.add_column(u'app_backend_blogindexpage', 'intro',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)
