...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HeadphonesCarouselItem.link_page'
        db.delete_column(u'app_backend_headphonescarouselitem', 'link_page_id')

        # Deleting field 'HeadphonesCarouselItem.link_document'
        db.delete_column(u'app_backend_headphonescarouselitem', 'link_document_id')

        # Deleting field 'HeadphonesCarouselItem.link_external'
        db.delete_column(u'app_backend_headphonescarouselitem', 'link_external')


    def backwards(self, orm):
        # Adding field 'HeadphonesCarouselItem.link_page'
        db.add_column(u'app_backend_headphonescarouselitem', 'link_page',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['wagtailcore.Page'], blank=True),
                      keep_default=False)

        # Adding field 'HeadphonesCarouselItem.link_document'
        db.add_column(u'app_backend_headphonescarouselitem', 'link_document',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['wagtaildocs.Document'], blank=True),
                      keep_default=False)

        # Adding field 'HeadphonesCarouselItem.link_external'
        db.add_column(u'app_backend_headphonescarouselitem', 'link_external',
    ...
    models = {
        ...
        u'app_backend.headphones': {
            'Meta': {'object_name': 'Headphones', '_ormbases': [u'wagtailcore.Page']},
            'blog': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'Headphones'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['app_backend.BlogPage']"}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '1024', 'null': 'True'}),
            'head_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'headphones_head_image'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['wagtailimages.Image']"}),
            u'page_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['wagtailcore.Page']", 'unique': 'True', 'primary_key': 'True'}),
