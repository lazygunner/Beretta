...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Headphones.headphone_id'
        db.add_column(u'app_backend_headphones', 'headphone_id',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=20, primary_key=True, db_index=True),
                      keep_default=False)


        # Changing field 'Headphones.page_ptr'
        db.alter_column(u'app_backend_headphones', u'page_ptr_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['wagtailcore.Page'], unique=True))

    def backwards(self, orm):
        # Deleting field 'Headphones.headphone_id'
        db.delete_column(u'app_backend_headphones', 'headphone_id')


        # Changing field 'Headphones.page_ptr'
        db.alter_column(u'app_backend_headphones', u'page_ptr_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['wagtailcore.Page'], unique=True, primary_key=True))
    ...
    models = {
        ...
        u'app_backend.headphones': {
            ...
            'headphone_id': ('django.db.models.fields.CharField', [], {'max_length': '20', 'primary_key': 'True', 'db_index': 'True'}),
            u'page_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['wagtailcore.Page']", 'unique': 'True'}),
