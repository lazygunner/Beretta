...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'app_backend_blogindexpagerelatedlink', (
            ...
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='related_links', to=orm['app_backend.BlogIndexPage'])),
        ))
        db.send_create_signal(u'app_backend', ['BlogIndexPageRelatedLink'])

        # Adding model 'BlogIndexPage'
        db.create_table(u'app_backend_blogindexpage', (
        ...
        db.send_create_signal(u'app_backend', ['BlogIndexPage'])

        # Adding model 'BlogPage'
        db.create_table(u'app_backend_blogpage', (
            (u'page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['wagtailcore.Page'], unique=True, primary_key=True)),
            ('body', self.gf('wagtail.wagtailcore.fields.RichTextField')()),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('head_image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='head_image', null=True, on_delete=models.SET_NULL, to=orm['wagtailimages.Image'])),
        ))
        db.send_create_signal(u'app_backend', ['BlogPage'])


    def backwards(self, orm):
        # Deleting model 'BlogIndexPageRelatedLink'
        db.delete_table(u'app_backend_blogindexpagerelatedlink')

        # Deleting model 'BlogIndexPage'
        db.delete_table(u'app_backend_blogindexpage')

        # Deleting model 'BlogPage'
        db.delete_table(u'app_backend_blogpage')
