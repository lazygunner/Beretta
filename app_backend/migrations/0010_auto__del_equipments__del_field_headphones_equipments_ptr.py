...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'app_backend_equipments', (
            ('blog', self.gf('django.db.models.fields.related.ForeignKey')(related_name='equipment', null=True, to=orm['app_backend.BlogPage'], on_delete=models.SET_NULL, blank=True)),
